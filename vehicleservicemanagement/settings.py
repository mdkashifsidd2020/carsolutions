...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = 'mohammadkashifsiddiqui2020@gmail.com' # this email will be used to send emails
EMAIL_HOST_PASSWORD = 'carzSolutions/requirements.txt' # host email password required
